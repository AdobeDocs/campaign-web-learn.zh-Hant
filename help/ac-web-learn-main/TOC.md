...
+ 訊息與傳遞 {#messages-and-deliveries}
   ...
   + [使用AI助理建立內容以產生內容](/help/design-the-delivery/create-content-using-the-ai-assistant.md)
...
+ Experience League即時錄製 {#exl-live-recordings}
   + [使用新的Adobe Campaign Web使用者介面快速前進](https://experienceleague.adobe.com/docs/events/experience-league-live-recordings/episodes/exl-live-episode-02-29-24.html?lang=zh-Hant){target="_blank"}
